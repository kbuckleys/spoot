...
GridView {
    ...
    // What is playing. A one-track album marks itself when it is the thing
    // playing -- drawn from live state, like a list row's marker.
    ...
    delegate: Item {
        ...
        Column {
            ...
            Text {
                ...
                text: mark + (model.rich.length ? model.rich : model.label)
                textFormat: model.rich.length ? Text.StyledText : Text.PlainText
